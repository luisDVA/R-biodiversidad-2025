...
> Usando el argumento `by` ya no se quedan 'pegados' los grupos
...
```{r}
p_db |> filter(str_detect(Package,"gg"))
```
...
### Positron
IDE de nueva generación para ciencia de datos multilenguaje 

### Inteligencia Artifial?
- `gander`   
- extensiones para Positron  
- guía [LLM+R](https://luisdva.github.io/llmsr-book/es/index.es.html)
