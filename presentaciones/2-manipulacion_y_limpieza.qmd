...
```{r}
paises_convenio <- tibble::tibble(pais=c("Peru","China","Indonesia"),
...
> Por ahora los datos de este paquete no se cargan con `data()`
...
## Práctica {background-color="#ffd6ff"}
...
## Ejercicio - `stringr` {background-color="#ffd6ff"}
